...
postHomeR = do
    ...
    when isProperCSV (do
                        ...
                        let sheetCSV = readSheet $ fillTable $ IOUtil.readCSVAsByteString TAB sheetBytes
    ...
    if isNothing maybeSheet
        then
            ...
            do
                ...
                sendResponse (TypedContent "text/csv" $ toContent $ writeCSVAsByteString TAB $ writeSheet sheet)
